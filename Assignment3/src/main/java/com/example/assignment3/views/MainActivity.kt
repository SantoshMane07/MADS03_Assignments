                ...
                setContent {
                    Assignment3Theme {
                        Scaffold {
                            ...
                            LaunchedEffect(authenticateStatus) {
                                navController.navigate(if (authenticateStatus) TopLevelDestination.UsersListScreen.route else TopLevelDestination.WelcomeScreen.route)
                            }
